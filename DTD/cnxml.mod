...
<!--                                                           -->
<!-- PUBLIC:  -//CNX//ELEMENTS CNXML 0.6 Elements//EN          -->
<!-- SYSTEM:  http://cnx.rice.edu/cnxml/0.6/DTD/cnxml.mod      -->
...
<!ENTITY % CNXML.inline '%CNXML.textextras;|%CNXML.emphasis.qname;|%CNXML.term.qname;|%CNXML.cite.qname;|%CNXML.cnxn.qname;|%CNXML.link.qname;|%CNXML.quote.qname;|%CNXML.foreign.qname;|%CNXML.span.qname;'>
...
<!ELEMENT %CNXML.document.qname; %CNXML.document.content; >
	  ...
	  <!ATTLIST %CNXML.document.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.metadata.qname; %CNXML.metadata.content; >
	  <!ATTLIST %CNXML.metadata.qname; %CNXML.xmlns.attrib;>
          <!ATTLIST %CNXML.metadata.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.content.qname; %CNXML.content.content;>
	  ...
	  <!ATTLIST %CNXML.content.qname; class CDATA #IMPLIED> 
...
<!ELEMENT %CNXML.glossary.qname; %CNXML.glossary.content; >
	  ...
	  <!ATTLIST %CNXML.glossary.qname; id ID #IMPLIED>
          <!ATTLIST %CNXML.glossary.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.name.qname; %CNXML.name.content;>
	  ...
	  <!ATTLIST %CNXML.name.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.cite.qname; %CNXML.cite.content;>
	  ...
	  <!ATTLIST %CNXML.cite.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.section.qname; %CNXML.section.content;>
	  ...
	  <!ATTLIST %CNXML.section.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.para.qname; %CNXML.para.content;>
	  ...
	  <!ATTLIST %CNXML.para.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.cnxn.qname; %CNXML.cnxn.content;>
	  ...
	  <!ATTLIST %CNXML.cnxn.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.link.qname; %CNXML.link.content;>
	  ...
	  <!ATTLIST %CNXML.link.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.equation.qname; %CNXML.equation.content;>
	  ...
	  <!ATTLIST %CNXML.equation.qname; class CDATA #IMPLIED>

<!ENTITY % CNXML.note.content "(%CNXML.inline;|%CNXML.code.qname;|%CNXML.para.qname;)*">
<!ELEMENT %CNXML.note.qname; %CNXML.note.content;>
	  ...
	  <!ATTLIST %CNXML.note.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.emphasis.qname; %CNXML.emphasis.content;>
	  ...
	  <!ATTLIST %CNXML.emphasis.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.list.qname; %CNXML.list.content;>
	  ...
	  <!ATTLIST %CNXML.list.qname; class CDATA #IMPLIED>

<!-- Name is listed as a child at any point but it is really only
allowed as the first child -->
<!ENTITY % CNXML.item.content "(%CNXML.inline;|%CNXML.code.qname;|%CNXML.special;|%CNXML.name.qname;|%CNXML.para.qname;)*">
<!ELEMENT %CNXML.item.qname; %CNXML.item.content;>
	  ...
	  <!ATTLIST %CNXML.item.qname; class CDATA #IMPLIED>

<!ENTITY % CNXML.code.content "(%CNXML.inline;)*">
<!ELEMENT %CNXML.code.qname; %CNXML.code.content;>
	  ...
	  <!ATTLIST %CNXML.code.qname; language CDATA #IMPLIED>
	  <!ATTLIST %CNXML.code.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.media.qname; %CNXML.media.content;>
	  ...
	  <!ATTLIST %CNXML.media.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.param.qname; %CNXML.param.content;>
	  ...
	  <!ATTLIST %CNXML.param.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.figure.qname; %CNXML.figure.content;>
	  ...
	  <!ATTLIST %CNXML.figure.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.subfigure.qname; %CNXML.subfigure.content;>
	  ...
	  <!ATTLIST %CNXML.subfigure.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.caption.qname; %CNXML.caption.content;>
	  ...
	  <!ATTLIST %CNXML.caption.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.example.qname; %CNXML.example.content;>
	  ...
	  <!ATTLIST %CNXML.example.qname; class CDATA #IMPLIED>      
...
<!ELEMENT %CNXML.exercise.qname; %CNXML.exercise.content;>
	  ...
	  <!ATTLIST %CNXML.exercise.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.problem.qname; %CNXML.problem.content;>
	  ...
	  <!ATTLIST %CNXML.problem.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.solution.qname; %CNXML.solution.content;>
	  ...
	  <!ATTLIST %CNXML.solution.qname; class CDATA #IMPLIED>	  
...
<!ELEMENT %CNXML.definition.qname; %CNXML.definition.content;>
	  ...
	  <!ATTLIST %CNXML.definition.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.term.qname; %CNXML.term.content;>
	  ...
	  <!ATTLIST %CNXML.term.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.meaning.qname; %CNXML.meaning.content;>
	  ...
	  <!ATTLIST %CNXML.meaning.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.seealso.qname; %CNXML.seealso.content;> 
	  ...
	  <!ATTLIST %CNXML.seealso.qname; id ID #IMPLIED>
	  <!ATTLIST %CNXML.seealso.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.rule.qname; %CNXML.rule.content;>
	  ...
	  <!ATTLIST %CNXML.rule.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.statement.qname; %CNXML.statement.content;>
	  ...
	  <!ATTLIST %CNXML.statement.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.proof.qname; %CNXML.proof.content;>
	  ...
	  <!ATTLIST %CNXML.proof.qname; class CDATA #IMPLIED>

<!ENTITY % CNXML.quote.content "(%CNXML.inline;|%CNXML.para.qname;)*">
<!ELEMENT %CNXML.quote.qname; %CNXML.quote.content;>
	  ...
	  <!ATTLIST %CNXML.quote.qname; class CDATA #IMPLIED>
...
<!ELEMENT %CNXML.foreign.qname; %CNXML.foreign.content;>
	  ...
	  <!ATTLIST %CNXML.foreign.qname; class CDATA #IMPLIED>

<!ENTITY % CNXML.span.content "%CNXML.inline.content;">
<!ELEMENT %CNXML.span.qname; %CNXML.span.content;>
	  <!ATTLIST %CNXML.span.qname; %CNXML.xmlns.attrib;>
	  <!ATTLIST %CNXML.span.qname; id ID #IMPLIED>
	  <!ATTLIST %CNXML.span.qname; class CDATA #IMPLIED>
...
<!ENTITY % CNXML.entry.mdl        "(%CNXML.inline;|%CNXML.media.qname;|%CNXML.code.qname;|%CNXML.para.qname;)*">
