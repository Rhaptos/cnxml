...
<!-- SYSTEM:  http://cnx.rice.edu/qml/1.0/DTD/qml1.mod          -->
...
<!ENTITY % QML.item.content "(%QML.question.qname;, %QML.resource.qname;*, %QML.answer.qname;+, %QML.hint.qname;*, %QML.key.qname;?)">
