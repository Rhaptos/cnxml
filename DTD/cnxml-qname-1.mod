...
<!--                                                               -->
<!-- PUBLIC:  -//CNX//ENTITIES CNXML 0.3.5 Qualified Names 1.0//EN   -->
<!-- SYSTEM:  http://cnx.rice.edu/cnxml/0.3.5/DTD/cnxml-qname-1.mod  -->
...
<!ENTITY % CNXML.xmlns    "http://cnx.rice.edu/cnxml/0.3.5" >
