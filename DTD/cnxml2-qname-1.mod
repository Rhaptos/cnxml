...
<!--                                                               -->
<!-- PUBLIC:  -//CNX//ENTITIES CNXML 0.2 Qualified Names 1.0//EN   -->
<!-- SYSTEM:  http://cnx.rice.edu/cnxml/0.2/DTD/cnxml2-qname-1.mod -->
...
<!ENTITY % CNXML.xmlns    "http://cnx.rice.edu/cnxml/0.2" >
...
<!ENTITY % CNXML.important.qname    "%CNXML.pfx;important" >
