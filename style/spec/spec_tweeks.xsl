...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="/">
	...
	<link rel="stylesheet" title="Default" type="text/css"
	  href="/cnxml/0.3.5/style/xhtml_max.css"/>

	<link rel="stylesheet" title="Default" type="text/css"
	  href="/cnxml/0.3.5/style/spec.css" />
	
	<link rel="alternate stylesheet" title="Style" type="text/css" 
	  href="/cnxml/0.3.5/style/xhtml_bw.css"/>
	
	<!--MODULE's NAME-->
	<title><xsl:value-of select="/cnx:module/cnx:name"/></title>
	
	<!-- Javascript for table of contents -->
	<script language="javascript" src="/cnxml/0.3.5/scripts/spec.js"/>
      </head>	
      <xsl:apply-templates />
    </html>
  </xsl:template>
