	...
	<div class="footer">
	  <table border="0" width="100%" class="footer" cellpadding="0" cellspacing="0">
		...
		<a href="http://cnx.rice.edu/" class="footer-logo">
		  <img src="/cnxml/0.4/style/common/the-connexions-project-footer.jpg" border="0" alt="The Connexions Project, Rice University" title="The Connexions Project, Rice University"/>
		</a> 
	      </td>
...
<!-- HOW I WAS TRYING TO MAKE CERTAIN EXMAMPLES NUMBER DIFFERENTLY
<xsl:choose>
