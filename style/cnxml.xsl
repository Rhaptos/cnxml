...
<!-- Through here. 8/14/00 by Sarah  -->
     <hr/>
     <a href='http://mntb.ece.rice.edu/bugreport.html'>Submit a BUG REPORT.</a><br/>
     <a href='http://mntb.ece.rice.edu/comment.html'>Submit a SUGGESTION.</a> 
    </body>
</xsl:template>
...
<xsl:choose>
	...
	<xsl:when test="@target and @module">
		<a href="http://mntb.ece.rice.edu/cgi-bin/showmodule.cgi?id={@module}/#{@target}">
