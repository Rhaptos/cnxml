...
function testmplayer()
{
    return (!isinstalled('MathPlayer.Factory.1'));
        ...
        <script language="javascript" src="/cnxml/0.3.5/scripts/ie-exercise.js"> </script>
	...
	<link rel="stylesheet" title="Default" type="text/css" href="/cnxml/0.3.5/style/ie/max.css">  </link>
