...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="md4 xhtml cc cnx rdf"
>

  <xsl:output indent="yes" method="xml"/>
  <xsl:strip-space elements="*"/>
  <xsl:preserve-space elements="md:abstract cnxml:preformat cnxml:code md4:abstract"/>
  ...
  <xsl:template match="md:license/@href">
